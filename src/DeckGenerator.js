...
export const classes = {
  ...
  miners: "史都华德 12F 阿米娅 炎熔 夜烟 远山 天火 爱丽丝 星极 艾雅法拉".split(" "),
  ...
  supporters: "梓兰 红 诗怀雅 安洁莉娜 霜叶 薄绿 清流 翎羽 白面鸮 空 波登可 真理 巫恋 安比尔 温蒂 塞雷娅 夜莺 黑角".split(" "),
  scorers: "阿消 崖心 食铁兽 雪雉 卡夫卡 铃兰 酸糖 普罗旺斯 闪灵 煌 阿 断罪者 赫默 伊芙利特 苏苏洛 大帝".split(" "),
...
const mini_sets = [
  ...
  //莱茵订单流
  ' 赫默 赫默|白面鸮 12F|远山|炎熔|天火|杜林 艾雅法拉 ',
  ...
  //调香师单核
  ' 星极|棘刺|微风 星极|棘刺|微风 调香师 断崖 ',

  //铃兰小家族
  ' 铃兰 阿 空爆|清道夫 摄影车 霜叶 推进之王 ',
