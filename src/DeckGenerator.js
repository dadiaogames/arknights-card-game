...
export const classes = {
  ...
  standers: "玫兰莎 芙兰卡 慕斯 柏喙 赫拉格 孑 宴 银灰 卡达 阿米娅-近卫 机械水獭 末药 森蚺 夜刀".split(" "),
  defenders: "米格鲁 蛇屠箱 斑点 年 可颂 古米 雷蛇 泥岩 砾 摄影车".split(" "),
  supporters: "梓兰 红 诗怀雅 安洁莉娜 霜叶 巫恋 翎羽 白面鸮 空 波登可 真理 安比尔 温蒂 黑角".split(" "),
  scorers: "阿消 崖心 食铁兽 阿米娅 铃兰 酸糖 闪灵 煌 阿 断罪者 赫默 苏苏洛 皇帝".split(" "),
