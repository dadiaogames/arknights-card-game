...
export const Rules = (props) => (<div>
  ...
  * 通关“黑角的金针菇迷境”苦难之路难度，并在最后一战至少摧毁1个红刀哥 (难)  <br/>
  * 使用两套截然不同的标准卡组完成危机等级40 (难)  <br/>
  * 使用一套标准卡组，连续三次成功通过危机等级50 (难) <br/>
  <br/>
  (截然不同: 指在卡组A中出现过的牌不能在卡组B中出现)<br/>
  (连续三次通过: 不能指定地图种子)<br/>
  <br/><br/>
  <h4>FAQ:</h4>
  <b>Q: 这游戏为什么这么屑？</b><br/>
  ...
  A: 除了+2攻击力的订单以外，都是的，其中+2攻击力订单如果预先选好场面上的干员，则会精准地加到他的身上，不过其他效果都是优先选择重置的单位(比如芙蓉、末药)，所以控制好重置与横置，是减少随机性的关键；<br/>
  <b>Q: {"<+1>"}是什么+1?</b><br/>
  A: 你有没有觉得{"<>"}很像一个镐子？<br/>
  <b>Q: “重置状态”是什么意思？</b><br/>
